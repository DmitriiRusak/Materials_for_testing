...
int x=10;
int a=x++;  
System out.print.ln(x,a); //x=11 a=10 <--сначала зделали действие(а=х), и только потом прибавили единицу

int xx=10;
int aa=++xx;
System out.print.ln(x,a); //x=11 a=11 <--сначала выполнили добовление 1 к хх,(стало 11), а потом присвоили значение уже инкрементированного хх переменной аа
//------------------------------------------------------------------------------------------------------------------------
...
//Бит -  это символ или сигнал, который может принимать два значения: включено или выключено, да или нет, высокий или низкий, 
//заряженный или незаряженный; в двоичной системе исчисления это 1 (единица) или 0 (ноль).
...
// если iznochalnii бит числа bil равен единице», т.е. Меняет изначальное значение на противоположное:
